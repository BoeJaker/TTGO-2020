...
void printTickerData(String ticker)
{
    ...
    if (response.error == "") {
        ...
        tft->drawString("BTC USD Price", 95, 11, 2);

        tft->setTextColor(TFT_WHITE);

        tft->fillRect(0, 120, 300, 38, TFT_BLACK); //price
        tft->fillRect(185, 60, 55, 20, TFT_BLACK); //rank

        tft->fillRect(100, 60, 55, 40, TFT_BLACK); //Volume
        tft->fillRect( 95, 75, 55, 40, TFT_BLACK); //Marketcap
        ...
        // hours change
        tft->fillRect(100, 200, 140, 25, TFT_BLACK);
        tft->setTextColor(TFT_YELLOW);
        ...
        tft->drawString("% Price 1h:", 11, 200, 4);
        ...
        tft->drawString("% Delta 24h:", 20, 200, 4);
        ...
        tft->drawString("% Price 7d:", 11, 200, 4);
